...
class VaccinationRecordViewSet(viewsets.ModelViewSet):
    """
    API endpoint that allows vaccination records to be viewed or edited.
    - Users can only manage vaccination records for pets they own.
    """
    ...
    def get_queryset(self):
        """
        This view should return a list of all vaccination records for the pets
...
class VeterinaryAppointmentViewSet(viewsets.ModelViewSet):
    """
    API endpoint that allows veterinary appointments to be viewed or edited.
    - Users can only manage appointments for pets they own.
    """
    ...
    def get_queryset(self):
        """
        This view should return a list of all veterinary appointments for the pets
        owned by the currently authenticated user.
        """
        if self.request.user.is_staff:
            return VeterinaryAppointment.objects.all()
        return VeterinaryAppointment.objects.filter(pet__owner=self.request.user)
...
class DailyCareLogViewSet(viewsets.ModelViewSet):
    """
    API endpoint that allows daily care logs to be viewed or edited.
    - Users can only manage care logs for pets they own.
    """
    ...
    def get_queryset(self):
        """
        This view should return a list of all care logs for the pets
        owned by the currently authenticated user.
        """
        if self.request.user.is_staff:
            return DailyCareLog.objects.all()
        return DailyCareLog.objects.filter(pet__owner=self.request.user)
...
class PetDocumentViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        """
        if self.request.user.is_staff:
            return PetDocument.objects.all()
