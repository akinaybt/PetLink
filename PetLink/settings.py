"""
Django settings for PetLink project.
...
SECRET_KEY = 'django-insecure-_kjrzxdztnzt23so6e#6+@$b@80xm#-m%l25x&^so=$82a#up^'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'rest_framework.authentication.SessionAuthentication',  # Для отображения имени
